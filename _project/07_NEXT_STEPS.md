...
<!-- ETAP26A_V2_REPAIR_NEXT_2026_05_17_START -->
## Etap 26A V2 repair - nastepny krok

1. Uruchomic APPLY V2.
2. Jesli guardy przejda, przejrzec diff.
3. Wykonac push helper tylko po review.
4. Wykonac runtime test publikacji.
5. Potem Etap 26B: admin UX plikow prywatnych.
<!-- ETAP26A_V2_REPAIR_NEXT_2026_05_17_END -->

<!-- ETAP37_DYNAMIC_CATEGORIES_NEXT_2026_05_17_START -->
...
<!-- ETAP37_DYNAMIC_CATEGORIES_NEXT_2026_05_17_END -->
...
## Etap 38 - kontrast selectow i komplet wartosci filtrow

Status: DO WDROZENIA PO ETAPIE 26A.

Do poprawy:
- ciemne tlo i jasny tekst w kazdym dropdownie/select,
- czytelny hover/focus/selected state,
- `Liczba pokoi`: Wszystkie, 1, 2, 3, 4, 5+,
- sprawdzenie innych list filtrow,
- jedno zrodlo prawdy dla opcji filtrow,
- guard `verify:select-contrast-and-filter-options-v38`.
